<template>
    <div>
        ...
        >
            ...
            <p>書式 外技第Ⅰ－３号(１)　令和 8年 6月 1日（改定）</p>
            ...
            <p class="mt-4">
                ２．一般社団法人建設技能人材機構（ＪＡＣ） 及び、その正会員団体（専門工事業団体等）に加入していた又は加入しておりません。
            ...
            <p class="mt-2">
                ８．当年度会費については納入期限（４月末日）後１か月を超えて滞納した場合、及び、受入負担金については本事業年度（４月１日から３月３１日）の期間内において３
回滞納された場合、自動退会となることに異議ありません。<br>
                <span class="text-red-600 underline">※自動退会した者が再び入会をする場合は、理事会の承認を得なければならないことをご承知おきください。</span>
            ...
            <p class="mt-2">
                10．貴会を退会した際には、就労管理システムの計画取消申請を速やかに行います。
            </p>
        </div>
        <!-- 注意文言 -->
